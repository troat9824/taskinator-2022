...
$(".list-group").on("blur", "textarea", function() {
  ...
  // replace object with new data of edit
  tasks[status][index].text = text;
  saveTasks();

  // turn the textarea back to a p element (not being edited)
  var taskP = $("<p>")
    .addClass("m-1")
    .text(text);
...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  // audit to check date for color coding
...
$(".card .list-group").sortable({
  ...
  update: function(event) {
    // array to store the task date in when updating
    var tempArr = [];

    // loop over current set of children in sotable list
